...
def test_no_dm_channel(reg_user, create_channel):
    ...
    with pytest.raises(AccessError):
        message_share_v1(another_token, og_message_id, message, channel_id, dm_id)
...
def test_non_dm_member(reg_user, create_channel):
    ...
    with pytest.raises(AccessError):
        message_share_v1(new_user_2['token'], og_message_id, shared_message_text, -1, dm_id)['shared_message_id']
...
def test_invalid_token(reg_user, create_channel):
    ...
    with pytest.raises(AccessError):
        message_share_v1("invalid_token", og_message_id, message, channel_id, dm_id)
