...
def test_message_pin_v1_token_channel(reg_user, basic_channel_name, basic_message): 
    clear_v2()
...
def test_message_pin_v1_channel_invalid_message_id(reg_user, basic_channel_name, basic_message):
    clear_v2()
    token_1 = reg_user(0)['token']
    channel_name = basic_channel_name
    channel_id = channels_create_v2(token_1, channel_name, True)['channel_id']
...
def test_message_pin_v1_channel_message_already_pinned(reg_user, basic_channel_name, basic_message):
    clear_v2()
    token_1 = reg_user(0)['token']
    channel_name = basic_channel_name
    channel_id = channels_create_v2(token_1, channel_name, True)['channel_id']
    ...
    with pytest.raises(InputError):
        message_pin_v1(token_1, message_id)# Message with ID message_id is already pinned
...
def test_message_pin_v1_auth_user_not_part_of_channel(reg_user, basic_channel_name, basic_message):
    clear_v2()
    token_1 = reg_user(0)['token']
    ...
    message_id = message_send_v2(token_1, channel_id, message)['message_id']
    with pytest.raises(AccessError):
        message_pin_v1(non_member_of_channel_token, message_id) # The authorised user is not a member of the channel
...
def test_message_pin_v1_auth_user_not_part_of_dm(reg_user, basic_message):
    ...
    message_id = message_senddm_v1(token_1, dm_id, message)['message_id']
    with pytest.raises(AccessError):
        message_pin_v1(non_member_of_dm_token, message_id)# The authorised user is not a member of the dm

def test_message_pin_auth_user_is_non_owner_of_channel(reg_user, basic_channel_name, basic_message):
    clear_v2()
    token_1 = reg_user(0)['token']
    ...
    message_id = message_send_v2(token_1, channel_id, message)['message_id']
    with pytest.raises(AccessError):
        message_pin_v1(non_owner_of_channel_token, message_id)# The authorised user is not an owner of the channel
...
def test_message_pin_auth_user_is_non_owner_of_dm(reg_user, basic_message):
    ...
    message_id = message_senddm_v1(token_1, dm_id, message)['message_id']
    with pytest.raises(AccessError):
        message_pin_v1(non_owner_of_dm['token'], message_id)# The authorised user is not an owner of the dm
